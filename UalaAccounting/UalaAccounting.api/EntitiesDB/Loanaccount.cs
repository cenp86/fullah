...
public partial class Loanaccount
{
    ...
    public virtual Loantransaction? ActivationtransactionkeyNavigation { get; set; }

    public virtual Branch? AssignedbranchkeyNavigation { get; set; }

    public virtual ICollection<Loanaccount> InverseRescheduledaccountkeyNavigation { get; set; } = new List<Loanaccount>();
    ...
    public virtual Loanaccount? RescheduledaccountkeyNavigation { get; set; }
}
